...
class PublicController extends Controller
{
    ...
    private const DOMAINS = [
        [
            ...
            'summary' => 'Permit To Work, incidents, observations, inspections, HIRADC, JSA, LOTO, gas test, PPE, CAPA, toolbox meetings and waste management.',
            'points' => [
                'Permit To Work raised in the field and approved by HSE',
                'Incident and near-miss reporting with the corrective actions that follow',
                'Inspections, HIRADC and JSA recorded as controlled documents',
                'PPE issue, replacement and expiry tracked per employee',
            ],
        ],
        [
            'key' => 'hr',
            ...
            'points' => [
                ...
                'Competencies and certificate expiry visible before they lapse',
                'Shift patterns, rosters and workforce assignment',
                'Leave requests follow the same approval flow as everything else',
            ],
        ],
        [
            'key' => 'operations',
        ...
        [
            'key' => 'management',
            'name' => 'Management',
            'summary' => 'KPI input and history, analytics, Report Center, and scheduled reports.',
            'points' => [
                'KPI definition, input and history',
                'Report Center with PDF and Excel export',
